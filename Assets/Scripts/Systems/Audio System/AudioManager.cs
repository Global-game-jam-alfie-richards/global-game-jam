...
public class AudioManager : MonoBehaviour
{
    ...
    public void SceneMusic()
    {
        ...
        {
            StoryManager storyManager = GameObject.FindFirstObjectByType<StoryManager>();

            if(storyManager.happiness >= 0.7)
            {
                PlayMusic("happy");
            }
            if(storyManager.happiness < 0.7 && storyManager.happiness > 0.4 )
            {
                PlayMusic("ok");
            }
            if(storyManager.happiness < 0.4)
            {
                PlayMusic("sad");
            }
        }
